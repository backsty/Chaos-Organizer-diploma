...
export default class Templates {
  ...
  static appMessagesMarkup(chatName = '', numberUsers = '', numberOnlineUsers = '') {
    ...
    <div class="messages__preview-record d_none">
      <div class="preview-record__modal">
        <video class="preview-record__video" autoplay muted playsinline></video>
        <div class="preview-record__timer">00:00</div>
        <div class="preview-record__controls">
          <button class="preview-record__btn preview-record__btn--send">Отправить</button>
          <button class="preview-record__btn preview-record__btn--close" title="Закрыть"></button>
        </div>
      </div>
    </div>
    <div class="messages__emoji d_none">
  ...
  static emojiMarkup(emoji) {
    ...
    return `<div class="messages-emoji__item">${emoji}</div>`;
  }
      ...
      <div class="register-page__body">
        ...
        <form name="register_form" method="post" class="register-page__content">
          <label class="register-page__item">
            ...
            <input name="login" class="login-page__input" type="text" required autocomplete="username">
          </label>
          <label class="register-page__item">
            <div class="register-page__text">Пароль</div>
            <input name="password" class="login-page__input" type="password" required autocomplete="current-password">
          </label>
